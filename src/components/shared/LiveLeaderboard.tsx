...
export function LiveLeaderboard({ variant = "compact" }: LiveLeaderboardProps) {
          ...
          <>
            ...
            {top3.length > 0 && (
              <div className="grid grid-cols-3 gap-4 md:gap-8 mb-12 items-end">
                ...
                {top3[0] && (
                  <PodiumCard entry={top3[0]} rank={1} highlight={top3[0].student_id === studentId} />
                )}
                {top3[2] ? (
                  <PodiumCard entry={top3[2]} rank={3} highlight={top3[2].student_id === studentId} />
                ) : (
                  <div />
                )}
              </div>
                  ...
                  {rest.map((entry, idx) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className={`bg-surface-container-lowest rounded-lg p-4 flex items-center justify-between ambient-shadow hover:translate-x-2 transition-transform cursor-pointer ${isMe ? "ring-2 ring-primary/30" : ""}`}
                      >
              ...
              return (
                <motion.div
                  ...
                  className={`
                    ...
                    ${isMe ? "bg-primary-container/15 ring-2 ring-primary/30" : isTop3 ? "bg-secondary-container/10" : "bg-surface-container-low"}
                  `}
                >
